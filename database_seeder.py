...
seeds = {
    ...
    # ── Curated Plants ──
    "curated/hero/title": {"value": "Curated <span class='text-accent-bronze italic'>Plants</span>", "type": "text"},
    "curated/hero/subtitle": {"value": "Curating nature's rarest botanical wonders for refined spaces.", "type": "text"},
    "curated/block1/title": {"value": "A Living Architecture", "type": "text"},
    "curated/block1/body": {"value": "In landscape architecture, drawings capture a moment—but gardens don’t stand still. They grow, expand, compete, and transform.", "type": "longtext"},
    "curated/block1/image": {"value": "https://pub-ce8688bc6c654bcfb99716f7c9373bcd.r2.dev/assets/arch_zigzag_1.png", "type": "media"},
    "curated/block2/title": {"value": "Scale and Maturity", "type": "text"},
    "curated/block2/body": {"value": "As consulting horticulturists, we often see thoughtfully designed spaces challenged by plant selections that don’t account for scale or maturity.", "type": "longtext"},
    "curated/block2/image": {"value": "https://pub-ce8688bc6c654bcfb99716f7c9373bcd.r2.dev/assets/arch_zigzag_2.png", "type": "media"},
    "curated/block3/title": {"value": "Intentional Growth", "type": "text"},
    "curated/block3/body": {"value": "With the intent to not redefine but strengthen the designs, we ensure that plant selections are informed, intentional, and future-ready.", "type": "longtext"},
    "curated/block3/image": {"value": "https://pub-ce8688bc6c654bcfb99716f7c9373bcd.r2.dev/assets/arch_zigzag_3.png", "type": "media"},
    "curated/block4/title": {"value": "Enduring Vision", "type": "text"},
    "curated/block4/body": {"value": "With a strong foundation in plant knowledge, we ensure that every selection supports lasting architectural harmony.", "type": "longtext"},
    "curated/block4/image": {"value": "https://pub-ce8688bc6c654bcfb99716f7c9373bcd.r2.dev/assets/arch_zigzag_4.png", "type": "media"},
    "curated/closing/title": {"value": "We don’t just develop gardens.<br>\n<span class='text-accent-bronze italic mt-4 block'>We future-proof them.</span>", "type": "longtext"},
